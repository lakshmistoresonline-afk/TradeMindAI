...
# Define the PEM parts explicitly to avoid any whitespace or indentation issues
pk_lines = [
    "-----BEGIN PRIVATE KEY-----",
...
# Join with proper newline characters
private_key = "\n".join(pk_lines) + "\n"
...
print(f"[*] Verified PEM Body Length: {len(private_key)}")
