...
def generate_final_verdict():
    # Load manifest and OOS
    with open('docs/step4_3/BASELINE_MANIFEST.json', 'r') as f:
        manifest = json.load(f)

    # Static extraction from previous reports
    verdict_md = f"""# TradeMind AI - Step 4.3 Final Robustness Verdict

## A. Verified Baseline (Step 4.2)
- **Strategy Version**: {manifest['strategy_version']}
- **Total Candidate Signals**: {manifest['trade_count']}
...
"""
    with open('docs/step4_3/FINAL_VERDICT.md', 'w', encoding='utf-8') as f:
        f.write(verdict_md)
    print("Generated docs/step4_3/FINAL_VERDICT.md")
