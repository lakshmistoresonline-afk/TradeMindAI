  ...
  return (
    <Box sx={{ pb: 10, maxWidth: 1000, mx: 'auto', p: 4, color: 'white' }}>
      <Box sx={{ mb: 10, textAlign: 'center' }}>
        ...
        <Typography variant="h6" sx={{ color: 'primary.main', fontWeight: 800 }}>CHOOSE YOUR INTELLIGENCE TIER</Typography>
      </Box>
      ...
      <Box sx={{ mt: 15, textAlign: 'center' }}>
         ...
         <Grid container spacing={4} sx={{ textAlign: 'left' }}>
            <Grid item xs={12} md={6}>
               <Typography variant="subtitle2" sx={{ fontWeight: 950, mb: 2, color: 'primary.main' }}>Does TradeMind AI execute trades?</Typography>
            ...
            <Grid item xs={12} md={6}>
               <Typography variant="subtitle2" sx={{ fontWeight: 950, mb: 2, color: 'primary.main' }}>What is the 'Observed Win Rate'?</Typography>
               <Typography variant="body2" sx={{ color: 'slategray', mb: 4 }}>
        ...
        <Paper sx={{
            ...
            {highlighted && (
                <Box sx={{
                    ...
                    bgcolor: 'primary.main', color: '#000', px: 2, py: 0.2, borderRadius: 0.5,
            ...
            <Typography variant="body2" sx={{ color: 'primary.main', fontWeight: 800, mb: 4 }}>{subtitle}</Typography>
