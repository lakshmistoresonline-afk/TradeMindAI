# PHASE 2P: INSTRUMENT MASTER AUDIT
...
- **Provider Mapping**: **OPERATIONAL**. Upstox and Dhan adapters have been updated to utilize the master service for F&O contract resolution.
